...
type IntegrationEventRepository interface {
	...
	CreateInternal(
		ctx context.Context, event integration.Event, options *toolkit.DBOptions,
	...
	FindByExternalEventIDInternal(
		ctx context.Context, instanceID string, externalEventID string, options *toolkit.DBOptions,
	) (*integration.Event, error)
	...
	UpdateStatusInternal(
		ctx context.Context, id string, status integration.EventStatus, errMsg *string, options *toolkit.DBOptions,
	) error
}
...
func (r *integrationEventRepositoryImpl) CreateInternal(
	...
	return toolkit.QueryMap[model.IntegrationEvents, integration.Event](
...
func (r *integrationEventRepositoryImpl) FindByIDInternal(
	...
	return toolkit.QueryOptionalMap[model.IntegrationEvents, integration.Event](
		ctx, r.db, stmt, r.mapper.ToDomain, options,
	)
}
