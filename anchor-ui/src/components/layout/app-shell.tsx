...
/**
 * Nanostack application shell. Mirrors the shared Echopoint `AppShell`
 * composition (echopoint/apps/frontend/src/components/app-shell.tsx) so Anchor
 * renders the same shell experience while keeping product/tenant behavior local.
 */
